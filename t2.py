...
def ai_contract():
    return {
        "purpose": "authoritative project snapshot for AI analysis",
        "rules": [
...
def build_snapshot(root):
    ...
    package_deps = set(package_info["dependencies"]) if package_info else set()
...
if __name__ == "__main__":
    ...
    print("✅ Perfect AI snapshot created:", OUTPUT_FILE)
